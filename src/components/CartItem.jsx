      ...
      <div className="flex flex-col md:flex-row p-0 md:p-3 gap-5 items-center">
        ...
        <div className="md:ml-10 self-start space-y-5 w-[100%] md:w-[70%]">
          ...
          <div className="flex items-center justify-between">
              ...
              className="bg-red-200 hover:bg-red-400 transition-transform text-red-800 hover:text-white
                duration-300 cursor-pointer rounded-full p-3 mr-3 w-[40px] items-center justify-center">
                {/* <FcDeleteDatabase /> */}
                <MdDelete/>
              </div>
          </div>
