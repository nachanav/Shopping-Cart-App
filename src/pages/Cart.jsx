...
const Cart = () => {
    ...
    <div>
  {
    ...
    (<div className="max-w-[1200px] mx-auto flex flex-col md:flex-row justify-center">
      ...
      <div className="w-[100%] md:w-[40%] mt-5 flex flex-col">
        ...
        <div className="flex flex-col p-5 gap-5 my-14 h-[100%] justify-between">
          ...
          <p className="font-bold text-xl"> <span className="text-gray-700 font-semibold">Total Amount </span> : ${totalAmount}</p>
          <button
          className="bg-green-700 hover:bg-purple-50 rounded-lg text-white
    ...
    (<div className="min-h-[80vh] flex flex-col items-center justify-center">
      ...
      <Link to={"/"}>
        <button
        className="bg-green-600 hover:bg-purple-50 rounded-lg text-white
